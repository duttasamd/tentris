  ...
  var SPARQLHighlightRules = function() {
    ...
    this.$rules = {
      ...
      "#keywords": [{
        ...
        regex: /\b[Aa][Dd][Dd]\b|\b[Aa][Ll][Ll]\b|\b[Aa][Ss]\b|\b[As][Ss][Cc]\b|\b[Aa][Ss][Kk]\b|\b[Bb][Aa][Ss][Ee]\b|\b[Bb][Ii][Nn][Dd]\b|\b[Bb][Yy]\b|\b[Cc][Ll][Ee][Aa][Rr]\b|\b[Cc][Oo][Nn][Ss][Tt][Rr][Uu][Cc][Tt]\b|\b[Cc][Oo][Pp][Yy]\b|\b[Cc][Rr][Ee][Aa][Tt][Ee]\b|\b\b[Dd][Aa][Tt][Aa]\b\b|\b[Dd][Ee][Ff][Aa][Uu][Ll][Tt]\b|\b[Dd][Ee][Ll][Ee][Tt][Ee]\b|\b[Dd][Ee][Sc][Cc]\b|\b[Dd][Ee][Ss][Cc][Rr][Ii][Bb][Ee]\b|\b[Dd][Ii][Ss][Tt][Ii][Nn][Cc][Tt]\b|\b[Dd][Rr][Oo][Pp]\b|\b[Ff][Ii][Ll][Tt][Ee][Rr]\b|\b[Ff][Rr][Oo][Mm]\b|\b[Gg][Rr][Aa][Pp][Hh]\b|\b[Gg][Rr][Oo][Uu][Pp]\b|\b[Hh][Aa][Vv][Ii][Nn][Gg]\b|\b[Ii][Nn][Ss][Ee][Rr][Tt]\b|\b[Ll][Ii][Mm][Ii][Tt]\b|\b[Ll][Oo][Aa][Dd]\b|\b[Mm][Ii][Nn][Uu][Ss]\b|\b[Mm][Oo][Vv][Ee]\b|\b[Nn][Aa][Mm][Ee][Dd]\b|\b[Oo][Ff][Ff][Ss][Ee][Tt]\b|\b[Oo][Pp][Tt][Ii][Oo][Nn][Aa][Ll]\b|\b[Oo][Rr][Dd][Ee][Rr]\b|\b[Pp][Rr][Ee][Ff][Ii][Xx]\b|\b[Rr][Ee][Dd][Uu][Cc][Ee][Dd]\b|\b[Ss][Ee][Ll][Ee][Cc][Tt]\b|\b[Ss][Ee][Pp][Aa][Rr][Aa][Tt][Oo][Rr]\b|\b[Ss][Ee][Rr][Vv][Ii][Cc][Ee]\b|\b[Ss][Ii][Ll][Ee][Nn][Tt]\b|\b[Tt][Oo]\b|\b[Uu][Nn][Dd][Ee][Ff]\b|\b[Uu][Nn][Ii][Oo][Nn]\b|\b[Uu][Ss][Ii][Nn][Gg]\b|\b[Vv][Aa][Ll][Uu][Ee][Ss]\b|\b[Ww][He][Ee][Rr][Ee]\b|\b[Ww][Ii][Tt][Hh]\b/
      }],
      "#logic-operators": [{
