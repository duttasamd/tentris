...
ace.define("ace/autocomplete", ["require", "exports", "module", "ace/keyboard/hash_handler", "ace/autocomplete/popup", "ace/autocomplete/util", "ace/lib/event", "ace/lib/lang", "ace/lib/dom", "ace/snippets"], function (require, exports, module) {
  ...
  (function () {
    ...
    var prefixes = ["wd", "wds", "wdv", "wdt", "wikibase", "p", "ps", "pq", "rdfs", "bd", "wdref", "psv", "psn", "pqv", "pqn", "pr", "prv", "prn", "wdno", "wdata", "schema", "rdf", "owl", "skos", "xsd", "prov", "bds", "gas", "hint", "base"]
    var builtins = ["str", "lang", "langmatches", "datatype", "bound", "sameterm", "isiri", "isuri", "iri", "uri", "bnode", "count", "sum", "min", "max", "avg", "sample", "group_concat", "rand", "abs", "ceil", "floor", "round", "concat", "substr", "strlen", "replace", "ucase", "lcase", "encode_for_uri", "contains", "strstarts", "strends", "strbefore", "strafter", "year", "month", "day", "hours", "minutes", "seconds", "timezone", "tz", "now", "uuid", "struuid", "md5", "sha1", "sha256", "sha384", "sha512", "coalesce", "if", "strlang", "strdt", "isnumeric", "regex", "exists", "isblank", "isliteral", "a", "bind"]
    this.filterCompletions = function (items, needle) {
      ...
      loop: for (var i = 0, item; item = items[i]; i++) {
        if (item.meta === 'keyword' || item.meta === 'builtinFunctions') {
          if (prefixes.indexOf(items[i].value.toLowerCase()) == -1) {
          ...
          if (builtins.indexOf(items[i].value.toLowerCase()) >= 0) {
            item.meta = 'built-in'
          }
        }
        ...
        if (caption.toLowerCase() !== lower && item.meta === 'prefix') {
          penalty = penalty + 100;
        } else if (item.meta === 'built-in') {
          penalty = penalty + 50;
        }
        ...
        // console.log(item.name + " - " + item.meta + " : " + penalty)
